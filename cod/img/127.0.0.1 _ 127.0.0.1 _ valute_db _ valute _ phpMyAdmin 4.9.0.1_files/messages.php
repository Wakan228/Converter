...
PMA_messages['strConfirmRowChange'] = "Вы пытаетесь уменьшить количество строк, но уже ввели данные в те строки, которые будут потеряны. Вы хотите продолжить?";
...
PMA_messages['strEmptyQuery'] = "Введите сначала SQL-запрос.";
...
PMA_messages['strQueryEmpty'] = "значение/subQuery пусто";
